    ...
    <div className="wrapper clear">
      <header className="d-flex justify-between align-center p-40">
        <div className="d-flex align-center">
          <img width={40} height={40} className="mr-15" src="/img/logo.svg"/>
          <div>
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/NikeLebronXVIIILow.png" alt="" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/NikeAirMax270.png" alt="" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/PumaXAkaBokuFutureRider.png" alt="" />
